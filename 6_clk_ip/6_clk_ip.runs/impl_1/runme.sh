...
HD_PWD='C:/Users/Kin/Desktop/FPGA/6_clk_ip/6_clk_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_ip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_ip.tcl -notrace
