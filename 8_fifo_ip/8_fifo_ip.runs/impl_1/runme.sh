...
HD_PWD='C:/Users/Kin/Desktop/FPGA/8_fifo_ip/8_fifo_ip/8_fifo_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_ip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fifo_ip.tcl -notrace
