...
HD_PWD='C:/Users/Kin/Desktop/FPGA/4_static_seg_led/4_static_seg_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_static_seg_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_static_seg_led.tcl -notrace
