...
HD_PWD='C:/Users/Kin/Desktop/FPGA/5_seg_led/5_seg_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_seg_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_seg_led.tcl -notrace
